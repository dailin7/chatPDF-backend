...
urlpatterns = [
    ...
    path("conversation/delete/<str:conversation_id>", conversation.delete_conversation),
    ...
    path("db_collection/get", db_collection.get_collections),
    path("db_collection/delete/<str:collection_name>", db_collection.delete_collection),
]
